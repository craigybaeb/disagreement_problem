...
class CBR:
  ...
  def __init__(self, categorical, neighbours, filepath='', raw_data=[], inputDict={}):
  ...
  def retrieve(self, index, num_neighbours):
    NEIGHBOURS_AND_DISTANCES = self.model.kneighbors(index.reshape(1,-1), n_neighbors=num_neighbours, return_distance=True)
